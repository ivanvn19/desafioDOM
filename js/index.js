...
if (cam==1) {
    ...
    contenedor.innerHTML = `<h6> Usted ha seleccionado: ${equipo1.tipo}</h6>
    ...
    // alert( `usted ha seleccionado ${equipo1.modelo} y tiene un valor de $ ${equipo1.precio} ARS por jornada`)
        ...
        let contenedor = document.createElement("div")
        contenedor.innerHTML = `<h6> Usted ha seleccionado: ${equipo2.tipo}</h6>
        ...
        let contenedor = document.createElement("div")
        contenedor.innerHTML = `<h6> Usted ha seleccionado: ${equipo3.tipo}</h6>
        ...
        let contenedor = document.createElement("div")
        contenedor.innerHTML = `<h6> Usted ha seleccionado: ${equipo4.tipo}</h6>
    ...
    if (lent==1) {
        ...
        let contenedor = document.createElement("div")
        contenedor.innerHTML = `<h6> Usted ha seleccionado: ${equipo5.tipo}</h6>
        ...
        // alert( `usted ha seleccionado ${equipo5.modelo} y tiene un valor de $ ${equipo5.precio} ARS por jornada`)
            ...
            let contenedor = document.createElement("div" )
            contenedor.innerHTML = `<h6> Usted ha seleccionado: ${equipo6.tipo}</h6>
            ...
            let contenedor = document.createElement("div")
            contenedor.innerHTML = `<h6> Usted ha seleccionado: ${equipo7.tipo}</h6>
            ...
            let contenedor = document.createElement("div")
            contenedor.innerHTML = `<h6> Usted ha seleccionado:  ${equipo8.tipo}</h6>
        ...
        if (mic==1) {
            ...
            let contenedor = document.createElement("div")
            contenedor.innerHTML = `<h6> Usted ha seleccionado: ${equipo9.tipo}</h6>
            ...
            // alert( `usted ha seleccionado ${equipo9.modelo} y tiene un valor de $ ${equipo9.precio} ARS por jornada`)
                ...
                let contenedor = document.createElement("div")
            contenedor.innerHTML = `<h6> Usted ha seleccionado: ${equipo10.tipo}</h6>
            ...
            document.body.appendChild(contenedor);
                ...
                let contenedor = document.createElement("div")
                contenedor.innerHTML = `<h6> Usted ha seleccionado: ${equipo11.tipo}</h6>
                ...
                let contenedor = document.createElement("div")
                contenedor.innerHTML = `<h6> Usted ha seleccionado: ${equipo12.tipo}</h6>
            ...
            if (trip==1) {
                ...
                let contenedor = document.createElement("div")
                contenedor.innerHTML = `<h6> Usted ha seleccionado: ${equipo13.tipo}</h6>
                ...
                // alert( `usted ha seleccionado ${equipo13.modelo} y tiene un valor de $ ${equipo13.precio} ARS por jornada`)
                    ...
                    let contenedor = document.createElement("div")
                    contenedor.innerHTML = `<h6> Usted ha seleccionado: ${equipo14.tipo}</h6>
                    ...
                    let contenedor = document.createElement("div")
                    contenedor.innerHTML = `<h6> Usted ha seleccionado: ${equipo15.tipo}</h6>
                    ...
                    let contenedor = document.createElement("div")
                    contenedor.innerHTML = `<h6> Usted ha seleccionado: ${equipo16.tipo}</h6>
...
document.body.append(jornadascantidad);
...
if(cantidad !=0 && cantidad!= "" ) {
    ...
    document.body.append(alertmonto);
